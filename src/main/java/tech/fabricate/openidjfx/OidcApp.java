...
public class OidcApp extends Application {
  ...
  private static final String CLIENT_ID = "oidcjfx-app";
  private static final String USERNAME = "oidcjfx-user";
  private static final String PASSWORD = "oidcjfx-pass";
  private static final String CLIENT_SECRET = "d0ac01ec-baec-45f8-adcd-d6f73dbdba1b";
  private static final String AUTH_URL = "http://localhost:8080/auth/realms/master/protocol/openid-connect/auth";
  private static final String TOKEN_URL = "http://localhost:8080/auth/realms/master/protocol/openid-connect/token";
